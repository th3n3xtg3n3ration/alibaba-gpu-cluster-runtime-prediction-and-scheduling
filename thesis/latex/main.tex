...
\hypersetup{pdftitle={Multi-Paradigm Runtime Prediction and Heterogeneous Scheduling Optimization in Large-Scale GPU Clusters}, pdfauthor={Hasan U\u{g}ur \c{C}elebi}, pdfsubject={M.Sc. Thesis, Yeditepe University Graduate School}, pdfkeywords={GPU cluster scheduling, runtime prediction, machine learning, decision-focused learning, discrete-event simulation}}
...
\supervisor{Assist. Prof. Dr. Onur Demir}{Yeditepe University}
...
\examineri{Assoc. Prof. Dr. Dionysis Goularas}{Yeditepe University}
\examinerii{Assist. Prof. Dr. Kamil Erdayandı}{Marmara University}
...
\input{chapters/3.dataset_and_workload}
\input{chapters/4.prediction_models}
\input{chapters/5.simulation_framework}

% conclusions
\input{chapters/6.results_and_discussion}
\input{chapters/7.conclusions_and_future_work}
